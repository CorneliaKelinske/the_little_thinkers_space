defmodule TheLittleThinkersSpaceWeb.Router do
  ...
  # scope "/api", TheLittleThinkersSpaceWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: TheLittleThinkersSpaceWeb.Telemetry
    end
  end
  ...
  scope "/", TheLittleThinkersSpaceWeb do
    ...
    resources "/add_crew_request", AddCrewRequestController
