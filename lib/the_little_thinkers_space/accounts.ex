defmodule TheLittleThinkersSpace.Accounts do
  @moduledoc """
  ...
  alias TheLittleThinkersSpace.Accounts.{User, UserNotifier, UserToken}
  ...
  def get_relationship_type(little_thinker_id, user_id) do
    query =
