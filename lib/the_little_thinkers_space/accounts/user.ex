defmodule TheLittleThinkersSpace.Accounts.User do
  @moduledoc """
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, TheLittleThinkersSpace.Repo)
  ...
  """
  def valid_password?(
        %TheLittleThinkersSpace.Accounts.User{hashed_password: hashed_password},
        password
      )
  ...
  def authorize(_action, _, _user), do: :error
end
